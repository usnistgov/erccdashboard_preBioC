...
\begin{itemize}
  \item Lab4.array.UHRR.HBRR - Fluorescent signal data from an Illumina 
...
exDat <- runDashboard(datType="count", exTable=Lab5.ILM.UHRR.HBRR.countTable,
...
exDat <- runDashboard(datType="array", exTable=Lab4.array.UHRR.HBRR,
                       filenameRoot = "Lab4.array",
